...
public class VentanaAfines extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaAfines frame = new VentanaAfines();
	 ...
	 * Create the frame.
	 */
	public VentanaAfines() {
		setResizable(false);
		setTitle("Peliculas Afines");
	...
	public void añadirPeliculas(ArrayList<String> pAfines) {
		
		for(int i=0; i<pAfines.size(); i++)
			model.addRow(new Object[]{pAfines.get(i)});
	}
